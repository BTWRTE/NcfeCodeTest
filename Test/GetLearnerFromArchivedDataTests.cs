...
{
    [TestClass]
    public class GetLearnerFromArchivedDataTests
    {
        ...
        public void Setup()
        {
            ...
            //TEST DATA - Add a Learner with an Id of 1 to ArchivedDataService
        }
        ...
        //100 FailoverEntries exist
        //LearnerResponse.IsArchived = true
        public void Test004_AssertNotNull()
        {
        ...
        //LearnerResponse.IsArchived = true
        public void Test005_AssertNotNull()
        {
            ConfigurationManager.AppSettings.Set("IsFailoverModeEnabled", "true");
