...
{
    [TestClass]
    public class GetLearnerFromLearnerDataAccessTests
    {
        ...
        public void Setup()
        {
            ...
            //TEST DATA - Add a Learner with an Id of 1 to LearnerDataAccess
        }
        ...
        //LearnerResponse.IsArchived = false
        public void Test002_AssertNotNull()
        {
            ConfigurationManager.AppSettings.Set("IsFailoverModeEnabled", "false");
        ...
        //100 FailoverEntries do not exist
        //LearnerResponse.IsArchived = false
        public void Test003_AssertNotNull()
        {
        ...
        public void Test006_AssertNull()
        {
            ConfigurationManager.AppSettings.Set("IsFailoverModeEnabled", "false");
